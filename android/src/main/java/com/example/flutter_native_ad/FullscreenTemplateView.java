 ...
 */
public class FullscreenTemplateView extends FrameLayout {
    ...
    public FullscreenTemplateView(Context context) {
        super(context);
    }

    public FullscreenTemplateView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initView(context, attrs);
    }

    public FullscreenTemplateView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initView(context, attrs);
    }

    @SuppressLint("NewApi")
    public FullscreenTemplateView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public void onFinishInflate() {
        ...
        primaryView = (TextView) findViewById(R.id.ad_headline);
        tertiaryView = (TextView) findViewById(R.id.ad_body);

        callToActionView = (Button) findViewById(R.id.ad_call_to_action);
